...
interface FormData
  extends Omit<IManagement, "id" | "user" | "orders" | "isDeleted" | "branch"> {
  password: string;
  contacts: Contact[];
  address: Address[];
  branch: string;
...
export default function CreateMemberForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Member created successfully", {
        description: data.message || "Your member has been added",
      });
  ...
  return (
    <Card className="w-full shadow-none p-0 border-0 py-6">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Create New Member</CardTitle>
      </CardHeader>
      <CardContent>
